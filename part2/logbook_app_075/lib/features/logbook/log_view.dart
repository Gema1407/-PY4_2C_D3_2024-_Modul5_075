...
class _LogViewState extends State<LogView> {
  ...
  bool _offlineSnackbarShown = false; // Tampilkan snackbar offline hanya sekali
  ...
  Future<void> _initDatabase() async {
    ...
    try {
      ...
      _controller.isSynced.value = true; // Koneksi berhasil → icon cloud hijau
      ...
      _controller.isSynced.value = false; // Tandai icon cloud jadi merah/orange
      if (mounted) {
  ...
  Future<void> _refreshData() async {
    // Reset snackbar flag tiap kali user sengaja refresh agar dapat feedback
    ...
    try {
      ...
      await _controller.loadLogs('team_A');
      // Koneksi berhasil: tandai synced dan reset flag
      _controller.isSynced.value = true; // icon cloud hijau kembali
      _offlineSnackbarShown = false;
    } catch (e) {
      if (mounted) {
        _controller.isSynced.value = false;
